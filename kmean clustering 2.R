##SCRIPT TITLE: K-mean clustering (Updated to reflect abundance in space and on earth)
#AUTHOR: Gbolaga Olanrewaju
#Date: 10/4/2022

#Use Log fold change of only differentially abundant protein. Do for just membrane proteins
...
###isolate differentially abundant in space

b<-a%>%
  filter(a$Log2.ratio>=0.2)

c<-a%>% filter(a$Log2.ratio<=-0.2)
